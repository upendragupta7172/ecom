...
const Cart = () => {
  ...
  const handleApplyPromo = () => {
    ...
    if (code === "UPENDRA10") {
      setDiscount(1000);
      setAppliedCode(code);
      toast.success("Promo Applied! Rs.1000 Saved");
    } else {
    ...
    <div className="max-w-6xl mx-auto p-6 pt-24 min-h-screen bg-white">
      ...
      {items.length === 0 ? (
        <div className="text-center py-20 border rounded-2xl bg-gray-50">
          ...
          <Button className="bg-blue-600" onClick={() => navigate('/product')}>
            Start Shopping
          </Button>
        </div>
      ) : (
                ...
                <div key={item._id} className="flex gap-4 border p-4 rounded-xl relative hover:shadow-md transition-shadow">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="font-bold text-lg mt-2">Rs. {Number(item.product?.productPrice).toLocaleString()}</p>
                    </div>
            ...
            <div className="border p-6 rounded-2xl bg-white shadow-sm sticky top-28">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-4 border-t flex justify-between items-center mb-6">
                  ...
                  <span className="text-2xl font-black text-blue-700">Rs. {finalTotal.toLocaleString()}</span>
                </div>
